...
public class GMapToolTip : ISerializable, IDisposable
{
    ...
    public static readonly Font DefaultFont =
        new(FontFamily.GenericSansSerif, 11, FontStyle.Regular, GraphicsUnit.Pixel);

    public static readonly Font TitleFont =
        new(FontFamily.GenericSansSerif, 11, FontStyle.Bold, GraphicsUnit.Pixel);
    ...
    public static readonly Pen DefaultStroke = new(Color.FromArgb(140, Color.Black));
    ...
    ///     text padding
    /// </summary>
    public Size TextPadding = new(20, 21);
